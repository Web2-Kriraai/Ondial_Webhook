...
/** Analysis API: lead_qualification.type for sales.lead_outreach only. */
...
function enrich(payload, campaign, callLog, contact, subServiceId) {
    ...
    } else if (canonicalSubId === "lead_outreach") {
        // Only sales + lead_outreach sends lead_qualification on analysis payloads.
