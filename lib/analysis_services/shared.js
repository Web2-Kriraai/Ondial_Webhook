...
function buildBaseEnrichedFields(payload, campaign, callLog, contact, companyDoc = null) {
    ...
    const features_enabled = {
        ...
        callback_scheduling: {
            ...
            // Prefer absolute ISO/wall-clock scheduled_at. Relative phrases
            // ("2 days after", "1 week after", "1 month after", "2 months after")
            // are accepted as fallback and resolved by Calling_system1 up to 90 days.
            preferred_schedule_format: 'absolute_iso_or_dd-MM-yyyy_HH:mm',
            relative_examples: [
                'in 2 days',
                '1 week after',
                '1 month after',
