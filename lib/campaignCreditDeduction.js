 ...
 */
async function loadBillingEntity(db, { campaignId, inboundConfigId }) {
    const tryIds = [campaignId, inboundConfigId]
        .map((id) => String(id || "").trim())
        .filter((id, i, arr) => id && ObjectId.isValid(id) && arr.indexOf(id) === i);
