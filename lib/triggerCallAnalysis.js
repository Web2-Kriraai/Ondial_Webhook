        ...
        if (campaignDoc && campaignDoc.followup === true && Array.isArray(campaignDoc.followupWhatsappTemplateIds) && campaignDoc.followupWhatsappTemplateIds.length > 0) {
            try {
                ...
                campaignDoc.whatsappTemplates = templateIds
                    ...
                    .map((t) => ({
                        id: String(t._id),
                        title: t.name || t.templateName || t.aisensyCampaignName || "",
                        templateName: t.templateName || t.name || "",
                        description: t.description || t.bodyText || t.name || "",
                        bodyText: t.bodyText || "",
                        aisensyCampaignName: t.aisensyCampaignName || "",
                        language: t.language || "en_US",
                        variableCount: t.variableCount || 0,
                        sampleValues: Array.isArray(t.sampleValues)
                            ? t.sampleValues
                            : Array.isArray(t.variableDefaults)
                              ? t.variableDefaults
                              : [],
                        variableDefaults: Array.isArray(t.variableDefaults)
                            ? t.variableDefaults
                            : Array.isArray(t.sampleValues)
                              ? t.sampleValues
                              : [],
                    }));
            } catch (wError) {
