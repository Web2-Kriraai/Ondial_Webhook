...
function detectCallProvider(inputCallId, callLogDoc) {
    ...
    if (pickString(callLogDoc?.telnyx?.call_control_id) || pickString(inputCallId)?.length > 20) {
        // Telnyx call_control_id is a long opaque string (not CA… Twilio SID, not UUID India).
