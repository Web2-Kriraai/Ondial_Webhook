...
async function mergeOutboundDuplicateCallLogs(coll, identity = {}) {
    ...
    // Sequential indexed finds — avoid 3-way $or COLLSCAN on call_unique_id.
    const docs = await findCallLogsByIdentity(
        coll,
        { leadId, callId, callUniqueId, includeCarrier: false },
